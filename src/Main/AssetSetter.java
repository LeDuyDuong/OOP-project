...
public class AssetSetter {
    ...
    public void setObject(){
        ...
        //Elevator
        gp.obj[mapNum][4] = new OBJ_Elevator_Up();
        gp.obj[mapNum][4].worldX = 8 * gp.tileSize;
        gp.obj[mapNum][4].worldY = 31 * gp.tileSize;

        gp.obj[mapNum][5] = new OBJ_Elevator_First();
        ...
        //Elevator
        gp.obj[2][0] = new OBJ_Elevator_Down();
        gp.obj[2][0].worldX = 8 * gp.tileSize;
        gp.obj[2][0].worldY = 31 * gp.tileSize;

        gp.obj[2][1] = new OBJ_Elevator_Ground();
